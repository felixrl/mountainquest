...
from game.level_generator import *
...
def run_game():
    ...
    level_generator.generate_rogue_level(MAP_DIMENSIONS)
    ### STOP LEVEL GENERATION
    cur_level = level_generator.get_level() 
    
    cur_game = Game(cur_state)
...
def game(screen, preload_map=None):
    try:
        ...
        if map == None:
            # Map generation
            map_generator = LevelGenerator(MAP_DIMENSIONS)
